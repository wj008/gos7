...
func (mb *TCPClientHandler) setConnectionParameters(address string, localTSAP uint16, remoteTSAP uint16) {
...
func (mb *TCPClientHandler) tcpConnect() error {
	mb.mu.Lock()
	defer mb.mu.Unlock()
	if mb.conn == nil {
...
func (mb *TCPClientHandler) isoConnect() error {
...
func (mb *TCPClientHandler) negotiatePduLength() error {
...
func (mb *TCPClientHandler) startCloseTimer() {
	if mb.IdleTimeout <= 0 {
		return
	}
...
func (mb *TCPClientHandler) flush(b []byte) (err error) {
...
func (mb *TCPClientHandler) logf(format string, v ...interface{}) {
	if mb.Logger != nil {
...
func (mb *TCPClientHandler) close() (err error) {
	if mb.conn != nil {
		err = mb.conn.Close()
		mb.conn = nil
	}
...
func (mb *TCPClientHandler) closeIdle() {
	mb.mu.Lock()
	defer mb.mu.Unlock()
